...
namespace FrameworkData
{
	...
	public class XCopy
	{
		...
		public static Task CopyAsync(string source, string destination, bool overwrite, bool nobuffering, EventHandler handler)
		{
			return Task.Factory.StartNew(() => { new XCopy().CopyInternal(source, destination, overwrite, nobuffering, handler); });
		}
