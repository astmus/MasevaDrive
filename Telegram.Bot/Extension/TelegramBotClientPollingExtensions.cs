...
namespace Telegram.Bot
{
	...
	public static class TelegramBotClientPollingExtensions
	{
		...
		public static void StartReceiving<TUpdateHandler>(this ITelegramBotClient botClient, CancellationToken cancellationToken = default) where TUpdateHandler : IUpdateHandler, new()
		{
