...
namespace Telegram.Bot.ExtensionsBase
{
	...
	public class QueuedUpdateReceiver : IYieldingUpdateReceiver
	{
		...
		/// </summary>
		public readonly ITelegramBot BotClient;

		/// <summary>
		/// Constructs a new <see cref="QueuedUpdateReceiver"/> for the specified <see cref="ITelegramBot"/>
		/// </summary>
		/// <param name="botClient">The <see cref="ITelegramBot"/> used for making GetUpdates calls</param>
		public QueuedUpdateReceiver(ITelegramBot botClient)
		{
