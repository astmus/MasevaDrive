...
namespace TestClient
{
	...
	/*
	[Program.MessageAttribute("M2")]
	public partial class Message2 : BaseClass
	{

		[Description("1")]
		public class SubMessage11
		{
			public SubMessage11( string S)
			{
			}
			[DisplayName("CutomName")]
			public void Made()
			{
			}
		}
		...
		[MessageAttribute("M1")]
		public class SubMessage1 : BaseClass
		{
			public void Handle()
			{
			}
		...
		[Message("M1")]
		public class SubMessage2 : BaseClass
		{
			public void Handle()
			{
			}
	...
	*/
	...
	{
		public static MessageType DeleteFile = new MessageType(1, "User ask to delete file");
		public static MessageType ConfirmDelete = new MessageType(2, "Ask to user delete confirm");
		public static MessageType DeleteConfirmed = new MessageType(3, "User confirm delete file");
		public static MessageType DeleteNotConfirmed = new MessageType(4, "User did not confirm delete file");
		private MessageType(int id, string name)	: base(id, name)
		{
		}
	}*/


	/*public class TeleMessage<T2> : Typedef<string, TeleMessage<T2>> where T2 : MSGType<Type>
	{
	...
	public abstract class TeleMessage
	{
	...
	[MessageType("1", typeof(SimpleMessage))]
	public class SimpleMessage : TeleMessage
	{
		public override void Run()
		{
			Console.WriteLine(query);
			Console.WriteLine(owner);
			Console.WriteLine("SimpleMessage Work");
		}
	}

	[MessageType("2", typeof(DeleteMessage))]
	public class DeleteMessage : TeleMessage
	{
		public override void Run()
		{
			Console.WriteLine(query);
			Console.WriteLine(owner);
			Console.WriteLine("DeleteMEssageWork");
		}
	}


	[MessageType("3", typeof(ConfirmedDelete))]
	public class ConfirmedDelete
	{

	}

	[MessageType("4", typeof(DeleteConfirmMessage))]
	public class DeleteConfirmMessage
	{

	}

	/*public class ComMessage<T> : SimpleMessage
	{
		public override string Alias => "1";
		
		static ComMessage()
		{
			type = typeof(ComMessage);
		}
	}*/
	...
	public class MessageTypeAttribute : Attribute
	{
		...
		public MessageTypeAttribute(string id, Type name)
		{
			Id = id;
			TypeOfHandler = name;
		}
		...
		public static IEnumerable<MessageTypeAttribute> GetAll()
		{
			var baseType = typeof(TeleMessage);
			var attributeType = typeof(MessageTypeAttribute);
			var assembly = Assembly.GetExecutingAssembly();
			foreach (Type type in assembly.GetTypes())
			{
				if (IsDefined(type, attributeType) && type.IsSubclassOf(baseType))
					yield return (type.GetCustomAttribute(attributeType) as MessageTypeAttribute);
			}
		}
	}
	...
	class Program
	{
		...
		{
			Dictionary<string, TeleMessage> dict = new Dictionary<string, TeleMessage>();
			var messateTypes = MessageTypeAttribute.GetAll();
			foreach (var attribute in messateTypes)
			{
				TeleMessage message = Activator.CreateInstance(attribute.TypeOfHandler) as TeleMessage;
				message.owner = new Owner();
				message.query = new Query();
				message.Run();
			}


				//var all = TeleMessage.GetAll<TeleMessage>();
				...
				//Type.GetVa types
				//types.FirstOrDefault(t => t.GetCustomAttribute<MessageAttribute>().Name == "1");
		}
