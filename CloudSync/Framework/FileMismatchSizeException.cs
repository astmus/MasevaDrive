...
namespace CloudSync.Framework
{
	public class FileMismatchSizeException : Exception
	{
		...
		public FileMismatchSizeException(string fileName, long itemSyncSize, long loadedFileSize, string pathToLoadedFile) : base(string.Format("{0} file mismatch size",fileName))
		{
